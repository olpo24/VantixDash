...
<div id="wrapper">
    <aside id="sidebar">
        ...
        <nav class="nav-menu">
            ...
            <a href="index.php?view=settings_plugin" class="nav-link <?php echo ($view == 'settings_plugin') ? 'active' : ''; ?>">
                <i class="ph ph-plug-connected"></i> 
                <span>Child Plugin</span>
            </a>
    ...
    <main id="content-wrapper">
        <header class="content-header">
            <h1>
                <?php 
                    // Dynamische Titel-Generierung basierend auf der View
                    $titles = [
                        'dashboard' => 'Übersicht',
            ...
            <?php 
                ...
                if (file_exists($viewFile)) { 
                    ...
                    echo '<div class="error-notice">
                            ...
                            <p>Die Seite "'.htmlspecialchars($view).'" wurde nicht gefunden.</p>
                          </div>'; 
                }
            ?>
        </section>
...
<script>
    // Die PHP Daten für JS verfügbar machen
    const rawData = <?php echo json_encode($siteData ? array_values($siteData) : []); ?>;
    
    // Sobald das Dokument geladen ist, die Tabelle befüllen
